...
## 2022 03 18 | Home
Unfortunately, needed to stay home due to appointments.  Not the best day to stay home when we discussed map, filter and reduce functions.  Still, I completed the mini ex.  It looks deceptively simple... and yet, it is very different syntax that the norm JS we have been working through.  
