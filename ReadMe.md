...
### 1500 | JQuery Faq 
Completed the Ex with the class with Justin's assign code.  Although I reused most of the code from previous, this gave me the opportunity to de-bug code that wouldn't auto-magically work!  Good practice...
